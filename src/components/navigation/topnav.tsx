			...
			{isFinishFetchOldUser && user &&
				<button className="flex gap-5 items-center group">
					...
					{isFinishFetchUserInfo && userInfo &&
						<Image className="rounded-full border-2 border-white group-hover:border-cyan" src={userInfo.avartar || "https://placehold.co/45x45"} width={45} height={45} alt="profile image" unoptimized={true} />
					}
				</button>
			}
		</div>
